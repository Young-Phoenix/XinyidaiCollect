 ...
 */
public class HouseInfoV1 implements Serializable{
    private int fang_id;
    ...
    public HouseInfoV1(){}
    public HouseInfoV1(String time, String address, String title, String huxing, double shoujia) {
        this.time = time;
    ...
    public double getFangdai() {
        return fangdai;
    }

    public void setFangdai(double fangdai) {
