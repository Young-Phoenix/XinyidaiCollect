...
import collect.xyd.net.cn.xinyidaicollect.view.VolumeView;
...
public class AudioRecordActivity extends Activity {
    ...
    private void startRecording() {
        ...
        mFileName = RecordUtils.getOutputMediaFile(RecordUtils.MEDIA_TYPE_AUDIO).getAbsolutePath().toString();
        ...
        public void run() {
            while (flag) {
                ...
                if (mRecorder != null && mRecordState == MediaRecorderState.RECORDING) {
                    ...
                    msg.what = db;
                    AudioRecordActivity.this.handler.sendMessage(msg);
                } else {
                    Message msg = new Message();
                    msg.what = db;
                    AudioRecordActivity.this.handler.sendMessage(msg);
